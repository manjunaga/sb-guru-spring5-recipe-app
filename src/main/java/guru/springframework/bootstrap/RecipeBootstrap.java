...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
	...
	private List<Recipe> getRecipes() {
		...
		Optional<UnitOfMeasure> teaspoonUomOptional = unitOfMeasureRepository.findByUomdescription("Teaspoon");
		if (!teaspoonUomOptional.isPresent()) {
			throw new RuntimeException("Teaspoon Expected UOM not found");
		}

		Optional<UnitOfMeasure> tablespoonUomOptional = unitOfMeasureRepository.findByUomdescription("Tablespoon");
		if (!tablespoonUomOptional.isPresent()) {
			throw new RuntimeException("Tablespoon Expected UOM not found");
		}

		Optional<UnitOfMeasure> cupUomOptional = unitOfMeasureRepository.findByUomdescription("Cup");
		if (!cupUomOptional.isPresent()) {
			throw new RuntimeException("Cup Expected UOM not found");
		}

		Optional<UnitOfMeasure> pinchUomOptional = unitOfMeasureRepository.findByUomdescription("Pinch");
		if (!pinchUomOptional.isPresent()) {
			throw new RuntimeException("Pinch Expected UOM not found");
		}

		Optional<UnitOfMeasure> ounceUomOptional = unitOfMeasureRepository.findByUomdescription("Ounce");
		if (!ounceUomOptional.isPresent()) {
			throw new RuntimeException("Ounce Expected UOM not found");
		}

		Optional<UnitOfMeasure> eachUomOptional = unitOfMeasureRepository.findByUomdescription("Each");
		if (!eachUomOptional.isPresent()) {
			throw new RuntimeException("Expected UOM not found");
		}

		Optional<UnitOfMeasure> dashUomOptional = unitOfMeasureRepository.findByUomdescription("Dash");
		if (!dashUomOptional.isPresent()) {
			throw new RuntimeException("Dash Expected UOM not found");
		}

		Optional<UnitOfMeasure> pintUomOptional = unitOfMeasureRepository.findByUomdescription("Pint");
		...
		if (!americanCategoryOptional.isPresent()) {
			throw new RuntimeException("American Expected UOM not found");
		}

		Optional<Category> italianCategoryOptional = categoryRepository.findByDescription("Italian");
		if (!italianCategoryOptional.isPresent()) {
			throw new RuntimeException("Italian Expected UOM not found");
		}

		Optional<Category> mexicanCategoryOptional = categoryRepository.findByDescription("Mexican");
		if (!mexicanCategoryOptional.isPresent()) {
			throw new RuntimeException("Mexican Expected UOM not found");
		}
...
//			throw new RuntimeException("FastFood Expected UOM not found");
//		}
...
//        Category fastFoodCategory = fastFoodCategoryOptional.get();
		...
		tacosRecipe.getIngredient().add(
				new Ingredient("cup sour cream thinned with 1/4 cup milk", new BigDecimal(4), cupUom, tacosRecipe));
		tacosRecipe.getIngredient()
